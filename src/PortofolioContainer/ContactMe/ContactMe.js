  ...
  return (
    <div className="contact">
        ...
        <div className="title-header">
          <h1 className="title-global">Contact</h1>
        </div>
        <div className="contact-content">
          <div className="contact-left">
            <h3>Contact info</h3>
            <span>
              <i className="fas fa-map-marker-alt"></i> Mansoura, Dakahlia, Egypt
            </span>
            <span>
          ...
          <div className="contact-right">
            <form className="form-all" ref={form} onSubmit={sendEmail}>
              ...
              <button className="btn second-highlighted-btn">Send</button>
            </form>
          </div>
        </div>
